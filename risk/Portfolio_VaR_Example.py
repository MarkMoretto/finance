...
### Get and concatenate data for multiple tickers
...
msg = f"The maximum expected 1-day loss\nfor our ${INIT_INVESTMENT:,.2f} portfolio,\n"
msg += f"with a {CI * 100:.0f}% confidence interval, is ${VaR_1_day:,.2f}."
print(msg)
